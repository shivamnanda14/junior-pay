...
export default function JuniorLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex justify-center items-center p-0 md:p-6 font-sans">
      {/* Mobile Device Frame */}
      <div className="w-full max-w-[420px] h-screen md:h-[840px] bg-slate-50 md:rounded-[44px] shadow-2xl flex flex-col overflow-hidden border-0 md:border-8 md:border-slate-800 relative">
        
        {/* Top App Header */}
       <header className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-2">
            <span className="text-xl">👦</span>
            <span className="font-extrabold text-slate-900 tracking-tight">Junior Pass</span>
          </div>
          <form action={logout}>
        ...
        <nav className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 px-6 py-3 flex justify-around items-center z-20">
